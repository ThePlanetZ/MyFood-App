                                ...
                                .addOnCompleteListener(new OnCompleteListener<String>() {
                                    ...
                                    public void onComplete(@NonNull Task<String> task) {
                                        if (task.isSuccessful() && task.getResult() != null) {
                                                    ...
                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> tokenTask) {
                                                            if (tokenTask.isSuccessful()) {
                                                                ...
                                                                Toast.makeText(Login.this, "Error: Failed to store FCM token", Toast.LENGTH_SHORT).show();
                                                            }
                                                        }
                                                    });
                                        } else {
                                            ...
                                            Toast.makeText(Login.this, "Error: Failed to fetch FCM token", Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
