...
public class Registration extends AppCompatActivity {
    TextInputLayout Fname,Lname,Email,Pass,cpass,mobileno,localadress,area,pincode;
    Spinner Cityspin;
    ...
    String fname,lname,emailid,password,confpassword,mobile,Localadress,Area,Pincode,role="Customer",City1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        localadress= (TextInputLayout) findViewById(R.id.Localadress);
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Localadress = localadress.getEditText().getText().toString().trim();
                            ...
                            if (task.isSuccessful()){
                                ...
                                databaseReference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        ...
                                        hashMap1.put("Local Address",Localadress);
    ...
    public boolean isValid(){
        ...
        area.setError("");
        localadress.setErrorEnabled(false);
        localadress.setError("");
        ...
        if(TextUtils.isEmpty(Localadress)){
            localadress.setErrorEnabled(true);
            localadress.setError("Fields Can't Be Empty");
        }else{
