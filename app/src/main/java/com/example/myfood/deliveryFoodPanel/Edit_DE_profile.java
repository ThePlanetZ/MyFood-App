...
public class Edit_DE_profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance().getReference("DeliveryPerson");
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isNameChanged() || isEmailChanged() || isLastChanged() || isPhoneChanged()) {
                    Toast.makeText(Edit_DE_profile.this, "Saved", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(com.example.myfood.deliveryFoodPanel.Edit_DE_profile.this, "No Changes Found", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//        });
    ...
    public void showData() {
        try {
            ...
            e.printStackTrace();
            Toast.makeText(com.example.myfood.deliveryFoodPanel.Edit_DE_profile.this, "Error displaying user data", Toast.LENGTH_SHORT).show();
        }
    }
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Toast.makeText(com.example.myfood.deliveryFoodPanel.Edit_DE_profile.this, "Password reset email sent.", Toast.LENGTH_SHORT).show();
                                    } else {
                                        // If password reset email sending fails
                                        Toast.makeText(com.example.myfood.deliveryFoodPanel.Edit_DE_profile.this, "Failed to send password reset email.", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                } else {
                    // If email is empty, show a message
                    Toast.makeText(com.example.myfood.deliveryFoodPanel.Edit_DE_profile.this, "Enter your email address.", Toast.LENGTH_SHORT).show();
                }
