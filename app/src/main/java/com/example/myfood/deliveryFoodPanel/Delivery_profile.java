...
public class Delivery_profile extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_customerprofil,null);
        ...
        titleName = v.findViewById(R.id.titleName_customer);
        titleEmail = v.findViewById(R.id.titleemail_customer);
        editProfile = v.findViewById(R.id.edit_customer);
        logout = v.findViewById(R.id.logoutIcon_customer);

        storageReference = FirebaseStorage.getInstance().getReference().child("DeliveryPerson_profile_images");
        retrieveUserData();
    ...
    private void retrieveUserData() {
        try {
            ...
            DatabaseReference chef = FirebaseDatabase.getInstance().getReference("DeliveryPerson").child(currentUserUid);
            ...
            chef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    try {
                        ...
                        String emailFromDB = dataSnapshot.child("EmailId").getValue(String.class);
                        ...
                        if (emailFromDB != null && firstNameFromDB != null && lastNameFromDB != null && mobileNoFromDB != null) {
                            ...
                            Toast.makeText(getContext(), "Error NULL text field", Toast.LENGTH_SHORT).show();
                        }
    ...
    public void passUserData() {
        try {
            ...
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("DeliveryPerson").child(currentUserUid);
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    try {
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            String emailFrom = dataSnapshot.child("EmailId").getValue(String.class);
                            String mobilefrom = dataSnapshot.child("Mobile No").getValue(String.class);


                            Intent intent = new Intent(requireContext(), Edit_DE_profile.class);
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                String currentUserUid = FirebaseAuth.getInstance().getCurrentUser().getUid();
                StorageReference imageRef = storageReference.child("DeliveryPerson_picture_" + currentUserUid + ".jpg");
    ...
    private void updateDatabaseWithImageUrl(String imageUrl) {
        try {
            ...
            // Update the Realtime Database with the image URL
            DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("DeliveryPerson").child(currentUserUid);
