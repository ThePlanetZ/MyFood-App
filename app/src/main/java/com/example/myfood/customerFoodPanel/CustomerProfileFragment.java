...
public class CustomerProfileFragment extends Fragment {
    ...
    private void retrieveUserData() {
        try {
            ...
            DatabaseReference chef = FirebaseDatabase.getInstance().getReference("Customer").child(currentUserUid);
    ...
    public void passUserData() {
        try {
            ...
            DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Customer").child(currentUserUid);
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    try {
                        ...
                        if (dataSnapshot.exists()) {
                            ...
                            Intent intent = new Intent(requireContext(),Customer_EditProfile.class);
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                String currentUserUid = FirebaseAuth.getInstance().getCurrentUser().getUid();
                StorageReference imageRef = storageReference.child("customer_picture_" + currentUserUid + ".jpg");
    ...
    private void updateDatabaseWithImageUrl(String imageUrl) {
        try {
            ...
            // Update the Realtime Database with the image URL
            DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Customer").child(currentUserUid);
